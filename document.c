...
/*
  Adds a paragraph after the speciﬁed paragraph number.
...
/*
  Adds a new line after the line with the speciﬁed line 
...
/*
  Appends a line to the speciﬁed paragraph.
*/ 
...
/*
  Removes the speciﬁed line from the paragraph. 
*/
...
/*
  The function will add the ﬁrst data lines number of lines from the 
